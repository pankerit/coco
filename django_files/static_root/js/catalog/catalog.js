...
//     //filter
//     $('.menu__filter').on('click', filter)
//     function filter(){
//         let brands = []
//         let sizes = []
//         let prices = []
//         //brand
//         let elementList = document.querySelectorAll('.menu__brandElement');
...
//         //brand
//         //sizes
//         elementList = document.querySelectorAll('.menu__size');
//         elementList.forEach(el=>{
...
//         //sizes
//         //prices
//         elementList = document.querySelector('.menu__priceBox');
//         prices.push(elementList.firstElementChild.value)
//         prices.push(elementList.lastElementChild.value)

//         //prices
//         return getFilter(brands, sizes, prices)
//     }
...
//     function getFilter(a,b,c){
//         let list = new Array()
//         if (a && b && c) return viewOnPage(json)
//         json.forEach(el=>{
//             if (a.includes(el.brand)) {
...
//                     <div class="new"></div>
//                 </div>
//                 <div class="productBox__name">${shoes.brand} ${shoes.name}</div>
...
//     json.forEach((el) => {
//         el.sizes.forEach(el =>{
//             if (el[1]) if (!productsSize.includes(el[0])) productsSize.push(el[0])
//         })
//     });
//     productsSize.sort()
